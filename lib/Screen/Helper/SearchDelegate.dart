...
//               onPressed: () {
//                 showSearch(context: context, delegate: _SearchAppBarDelegate(TotUser));
//               },
//             )
//           ],
...
//   _SearchAppBarDelegate(List<QueryDocumentSnapshot<Object>> TotUser);
//
//   Object get TotUser => null;
//
//
//   @override
...
//         ? items
//         : items.where((element) => element.title.toLowerCase().contains(query.toLowerCase())).toList();
